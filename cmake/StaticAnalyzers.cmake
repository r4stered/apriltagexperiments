macro(apriltagexperiments_enable_cppcheck WARNINGS_AS_ERRORS CPPCHECK_OPTIONS)
  ...
  if(CPPCHECK)
    ...
    if("${CPPCHECK_OPTIONS}" STREQUAL "")
      ...
      set(CMAKE_CXX_CPPCHECK ${CPPCHECK} --template=${CPPCHECK_TEMPLATE} ${CPPCHECK_OPTIONS} --include="${CMAKE_CURRENT_BINARY_DIR}/_deps/catch2-src/src/")
    endif()
...
macro(apriltagexperiments_enable_clang_tidy target WARNINGS_AS_ERRORS)
...
macro(apriltagexperiments_enable_include_what_you_use)
